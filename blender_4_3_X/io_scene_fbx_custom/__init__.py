...
def import_panel_include(layout, operator):
    header, body = layout.panel("ARibeiro_FBX_import_include", default_closed=False)# [Alessandro]
...
def import_panel_transform(layout, operator):
    header, body = layout.panel("ARibeiro_FBX_import_transform", default_closed=False)# [Alessandro]
...
def import_panel_transform_orientation(layout, operator):
    header, body = layout.panel("ARibeiro_FBX_import_transform_manual_orientation", default_closed=False)# [Alessandro]
...
def import_panel_animation(layout, operator):
    header, body = layout.panel("ARibeiro_FBX_import_animation", default_closed=True)# [Alessandro]
    header.use_property_split = False
...
def import_panel_armature(layout, operator):
    header, body = layout.panel("ARibeiro_FBX_import_armature", default_closed=True)# [Alessandro]
...
def export_panel_include(layout, operator, is_file_browser):
    header, body = layout.panel("ARibeiro_FBX_export_include", default_closed=False)# [Alessandro]
    header.label(text="Include")
    if body:
...
def export_panel_transform(layout, operator):
    header, body = layout.panel("ARibeiro_FBX_export_transform", default_closed=False)# [Alessandro]
    header.label(text="Transform")
    if body:
        body.prop(operator, "global_scale")
...
def export_panel_geometry(layout, operator):
    header, body = layout.panel("ARibeiro_FBX_export_geometry", default_closed=True)# [Alessandro]
...
def export_panel_armature(layout, operator):
    header, body = layout.panel("ARibeiro_FBX_export_armature", default_closed=True)# [Alessandro]
    header.label(text="Armature")
    if body:
...
def export_panel_animation(layout, operator):
    header, body = layout.panel("ARibeiro_FBX_export_bake_animation", default_closed=True)# [Alessandro]
    header.use_property_split = False
...
class ARibeiro_IO_FH_fbx(bpy.types.FileHandler):
    bl_idname = "ARibeiro_IO_FH_fbx"
    bl_label = "FBX(@aRibeiro)"
    bl_import_operator = "import_scene.aribeirofbx"# [Alessandro]
    bl_export_operator = "export_scene.aribeirofbx"# [Alessandro]
...
def menu_func_import(self, context):
    self.layout.operator(ARibeiro_ImportFBX.bl_idname, text="FBX (.fbx) (@aRibeiro)")


def menu_func_export(self, context):
    self.layout.operator(ARibeiro_ExportFBX.bl_idname, text="FBX (.fbx) (@aRibeiro)")
